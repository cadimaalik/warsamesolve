...
export default function App() {
  ...
  const handleCalculate = useCallback(() => {
    ...
    try {
      ...
      switch (method) {
        case 'lagrange':
          res = lagrangeInterpolation(points, xVal);
          break;
        case 'cubicSplines':
          res = cubicSplineInterpolation(points, xVal);
          break;
        case 'leastSquares':
          switch (subMethod) {
            case 'linear':
              res = linearRegression(points, xVal);
              break;
            case 'polynomial':
              res = polynomialRegression(points, polyDegree, xVal);
              break;
            case 'exponential':
            case 'power':
            case 'rational':
              res = nonlinearRegression(points, subMethod, xVal);
              break;
            default:
              res = linearRegression(points, xVal);
          }
          ...
          {!result && (
            <div style={{
              ...
              <div style={{
                ...
                Lagrange · Cubic Splines · Least-Squares Regression
              </div>
            </div>
          )}
